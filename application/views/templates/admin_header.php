						...
						<div class="admin_aside_content">
							<div>
								<ul class="toggle">
								    ...
								    <li><a href="<?=base_url()?>admin/add_achieve"><span class="ui-icon  ui-icon-flag"></span>成果專區</a></li>
								    <li><a href="<?=base_url()?>admin/add_signup"><span class="ui-icon ui-icon-plusthick"></span>活動報名新增</a></li>
								    <li><a href="<?=base_url()?>admin/edit_signup"><span class="ui-icon  ui-icon-pencil"></span>活動報名修改</a></li>
								  </ul>
							</div>
						</div>
					</div>
