...
<div class="inner">
    <div class="col span_12_of_12">
        <table class="table">
            ...
            <tr>
                <td id="signup_name" width="40%"><a href="<?=base_url()?>signup/signupdetail/<?php echo $signup_item['s_id']; ?>"> <?php echo htmlspecialchars_decode($signup_item['title']);?> </a></td>
                <td width="20%">
                    <?php
                ...
                <td width="20%"><?php echo date('Y-m-d',$signup_item['start_date']);?>~
                                <?php echo date('Y-m-d',$signup_item['end_date']);?></td>
                <td width="10%"><?php echo date('Y-m-d',$signup_item['begin_at']);?></td>
